...
>
	<div class="flex" use:clickOutsideAction={closeOnClickOutside}>
		<button
			...
			class="relative flex-shrink-0 overflow-hidden z-10 whitespace-nowrap inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded-l-lg hover:bg-gray-200  focus:ring-primary-600 focus:border-primary-600"
			type="button"
			role="combobox"
	...
	<TelInput
		...
		options={options}
		required={true}
		class="text-sm rounded-r-lg block w-full p-2.5 focus:outline-none border  focus:ring-primary-600 focus:border-primary-600 border-gray-300 border-l-gray-100 bg-gray-50 text-gray-900"
	/>
</div>