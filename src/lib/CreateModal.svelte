        ...
        <form action="?/create" method="POST">
            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="name" bind:value={name} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Type product name" required>
                </div>
                <div>
